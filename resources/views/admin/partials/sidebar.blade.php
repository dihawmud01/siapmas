      ...
      <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="/admin/kadermapaba/">
            <i class="bi bi-circle"></i><span>Makesta</span>
          </a>
        </li>
        <li>
          <a href="/admin/kaderpkd/">
            <i class="bi bi-circle"></i><span>Lakmud</span>
          </a>
        </li>
        <li>
          <a href="/admin/kaderpkl/">
            <i class="bi bi-circle"></i><span>Lakut</span>
          </a>
        </li>
        <li>
          <a href="/admin/kaderpkn/">
            <i class="bi bi-circle"></i><span>Latinpel</span>
          </a>
        </li>
      </ul>
