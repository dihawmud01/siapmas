          ...
          <form action="/admin/calendar/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <select name="penyelenggara" class="form-select" required aria-label="penyelenggara">
                  ...
                  <option value="Rayon Teknik">PAC BATURRADEN</option>
                  <option value="Rayon Hukum">PAC KEDUNGBANTENG</option>
                  <option value="Rayon Ulul Albab">PAC CILONGOK</option>
                  <option value="Rayon Fkip">PAC PURWOJATI</option>
                  <option value="Rayon Fikom">PAC KARANGLEWAS</option>
                  <option value="Rayon Ekonomi">PAC PURWOKERTO BARAT</option>
              </select><br>
          </div>
            <div class="mb-3">
