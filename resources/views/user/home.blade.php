  ...
  <section id="hero">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(https://pmiiuninus.com/storage/home/homepage.jpg);">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Selamat Datang <br> Di Website PC IPNU IPPNU BANYUMAS </h2>
        ...
        <div class="carousel-item" style="background-image: url({{ asset('storage/img/' . $hom->gambar ) }});">
          <div class="carousel-container">
            <div class="container position-absolute top-50 start-50 translate-middle">
              ...
              <a href="{{ $hom->link }}" class="btn-get-started scrollto animate__animated animate__fadeInUp">Gett Started</a>
            </div>
          </div>
        </div>
        @endforeach
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          ...
          <h6 class="text-center pr-2 pl-2">IPNU IPPNU Merupakan Lorem ipsum dolor sit, amet consectetur adipisicing elit. Earum quidem voluptas beatae iusto saepe eaque vel doloribus non aliquam, a esse molestiae illo ab exercitationem vero officiis quaerat veniam natus!.</h6>
    ...
    <section id="facts">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>Rekan Rekanita dalam Angka</h3>
          <h2>Data Kader PC IPNU IPPNU BMS </h2>
        </header>
    ...
    <div class="col-12 p-4"  data-aos="fade-up">
      <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title">Data Rekan & Rekanita <span>Dari Tahun Ke Tahun</span></h5>
    ...
    <div class="p-4"  data-aos="fade-up">
      ...
      <div class="col-12 mb-2"  data-aos="fade-up">
        <div class="card">
          <div class="card-body">
          <h5 class="card-title">Kader Berdasarkan <span>| PAC </span></h5>
          <!-- Pie Chart -->
