                    ...
                    @foreach ($lakmudCadres as $lakmud)
                        <tr>
                            ...
                            <td class="text-center">
                                <a
                                    href="{{ asset('storage/images/' . ($lakmud['photo'] != 'default.png' ? 'members/' . strtolower(str_replace(' ', '-', $lakmud->pac->pac)) . '/photo/' . $lakmud['photo'] : 'default.png')) }}">
                                    <img
                                        src="{{ asset('storage/images/' . ($lakmud['photo'] != 'default.png' ? 'members/' . strtolower(str_replace(' ', '-', $lakmud->pac->pac)) . '/photo/' . $lakmud['photo'] : 'default.png')) }}"
                                        width="60"
