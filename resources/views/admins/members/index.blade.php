    ...
    @if (! $members->isEmpty())
                ...
                <div class="row align-items-center mb-3">
                    <div class="col-12 d-flex justify-content-between align-items-end">
                        ...
                        @endphp
                            ...
                            >
                            <button type="submit" name="filter" value="IPNU" 
                                class="btn {{ request('filter') === 'IPNU' ? 'btn-success' : 'btn-outline-dark' }}">
                                IPNU
                            </button>
                            <button type="submit" name="filter" value="IPPNU" 
                                class="btn {{ request('filter') === 'IPPNU' ? 'btn-success' : 'btn-outline-dark' }}">
                                IPPNU
                            </button>
                            <a href="{{ route('dashboard.members.index') }}" 
                                class="btn {{ $isSearchActive || request('filter') ? 'btn-outline-dark' : 'btn-success' }}" id="all-button">
                                Semua
                            </a>
                                <input
                                    type="text"
                                    ...
                                    placeholder="Cari Nama {{ auth()->user()->role_id != 3 ? '' : '' }}"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                // Aktifkan Input Setelah Klik Tombol "Semua"
                function checkAllButtonActive() {
                    if (allButton.classList.contains("btn-success")) {
                        searchInput.removeAttribute("disabled"); // Aktifkan input
                    } else {
                        searchInput.setAttribute("disabled", "true"); // Nonaktifkan input
                    }
                }
