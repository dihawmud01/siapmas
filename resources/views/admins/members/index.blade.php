                            ...
                            <form action="{{ route('dashboard.members.index') }}" method="GET" class="w-100">
                                <div class="row g-2">
                                    ...
                                    <div class="col-12 col-md-auto d-flex flex-wrap gap-2">
                                        ...
                                        {{-- pertahankan pencarian saat klik filter --}}
                            ...
                            <tbody>
                                @foreach ($members as $idx => $member)
                                    <tr class="align-middle">
                                        ...
                                        <td class="text-center">
                                            <a
                                                href="{{ public_path('storage/images/members/' . ($member->photo != 'default.png' ? $member->photo : 'images/default.png')) }}">
                                                <img src="{{ public_path('storage/images/members/' . ($member->photo != 'default.png' ? $member->photo : 'images/default.png')) }}"
                                                    width="60" class="img-fluid img-thumbnail" style="max-height: 60px"
                                                    alt="{{ __('Foto Anggota') }}" />
                                            </a>
                                        ...
                                        <td class="btn-action text-center">
                                            <a href="{{ route('dashboard.members.show', $member) }}"
                                            ...
                                            <form action="{{ route('dashboard.members.destroy', $member) }}"
