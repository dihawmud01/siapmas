    ...
    <div class="card info-card sales-card">
        <div class="container my-3">
            <div class="d-flex justify-content-between align-items-center my-3">
                ...
                <form method="GET" action="{{ route('dashboard.makesta') }}">
                    ...
                    @foreach ($makestaCadres as $cadre)
                        <tr>
                            ...
                            <td class="text-center">
                                <a
                                    href="{{ asset('storage/images/' . ($cadre['photo'] != 'default.png' ? 'members/' . strtolower(str_replace(' ', '-', $cadre->pac->pac)) . '/photo/' . $cadre['photo'] : 'default.png')) }}">
                                    <img
                                        src="{{ asset('storage/images/' . ($cadre['photo'] != 'default.png' ? 'members/' . strtolower(str_replace(' ', '-', $cadre->pac->pac)) . '/photo/' . $cadre['photo'] : 'default.png')) }}"
                                        width="60"
                            ...
                            <td class="text-center">
                                <a
                                    href="{{ route('dashboard.members.show', ['member' => $cadre->id]) }}"
