...
<body>
    ...
    <div class="secondary-title" style="padding-bottom: 4px">
        ...
        <br />
        IKATAN PELAJAR NAHDLATUL ULAMA {{ $levelData->nama }} KABUPATEN BANYUMAS
        <br />
    ...
    <div class="content">
        ...
        <div class="date">
            <table class="date-table">
                <tr>
                    <td width="50%"></td>
                    <td width="88px">
                        <p class="col-1">Ditetapkan di</p>
                    </td>
                    <td width="8px">
                        <p class="bracket-pair">:</p>
                    </td>
                    <td width="128px">
                        <p>Purwokerto</p>
                    </td>
        ...
        <div class="signature">
            ...
            <table class="signature-table">
                ...
                <tr>
                    <td class="bordered-td">
                        <div class="signature-space">
                            <img src="{{ public_path('assets/images/sp/signatures/chairman-signature.png') }}"
                                class="chairman-signature-img" alt="Tanda Tangan Ketua" />
                        </div>
                        <p><strong>FAHMI ABDURRAHMAN</strong></p>
                    </td>
                    <td class="bordered-td">
                        <div class="signature-space">
                            <img src="{{ public_path('assets/images/sp/signatures/secretary-signature.png') }}"
                                class="secretary-signature-img" alt="Tanda Tangan Sekretaris" />
                        </div>
                ...
                <tr>
                    <td>
                        <p>NIA. 11.20.99.00002</p>
                    </td>
                    <td>
                        <p>NIA. 11.20.99.00032</p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="attachment-content">
            <table class="content-table">
                ...
                <tr>
                    ...
                    <td>
                        <p>{{ $letter->organization_department_coordinator }}</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <p>{{ $letter->cadre_department_coordinator }}</p>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <p>{{ $letter->dakwah_department_coordinator }}</p>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <p>{{ $letter->culture_department_coordinator }}</p>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <p>{{ $letter->economy_institution_director }}</p>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <p>{{ $letter->press_institution_director }}</p>
                    </td>
                </tr>
                <tr>
                    <td>
