...
<html lang="id">
    ...
    <body>
        ...
        <div class="secondary-title">
            ...
            KABUPATEN BANYUMAS
            <br />
            MASA BAKTI {{ $letter->start_period . '-' . $letter->end_period }}
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            Pimpinan Anak Cabang Ikatan Pelajar Putri Nahdlatul Ulama Kecamatan Baturraden Masa Bakti
                        ...
                        <div>
                            <ol>
                                <li>
                                    ...
                                    Masa Bakti {{ $letter->start_period . '-' . $letter->end_period }}. Sebagaimana
                                    terlampir;
                                </li>
                                <li>
                                    Menugaskan kepada semua Pengurus Pimpinan Anak Cabang Ikatan Pelajar Putri Nahdlatul
                                    Ulama {{ str_replace(['Uin', 'Unu'], ['UIN', 'UNU'], ucwords(strtolower($pac))) }}
                                    Masa Bakti {{ $letter->start_period . '-' . $letter->end_period }} untuk
