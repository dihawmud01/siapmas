...
@section('content')
    <x-breadcrumb
        :values="[__('Surat-menyurat'), __('Pengajuan Surat Pengesahan (SP)'), __('Buat Pengajuan'), strtoupper(request()->query('type'))]"
    ></x-breadcrumb>
        ...
        <div class="card-header bg-transparent">
            <div class="d-flex align-items-center p-4">
                <div class="d-flex flex-column w-100">
                    <h3 class="fw-bold">{{ __('Form Pengajuan Surat Pengesahan PAC/PR/PK') }} - {{ strtoupper(request()->query('type')) }}</h3>
                </div>
            </div>
        </div>
