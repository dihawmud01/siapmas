        ...
        <div class="card rounded-4 border-0 shadow-lg" style="max-width: 900px; width: 100%">
            <div class="row g-0">
                <div class="col-md-6 d-none d-md-block">
                    <img src="{{ storage_path('../storage/images/default.png') }}" class="img-fluid rounded-start h-100"
                        style="object-fit: cover" alt="Login Image" />
                </div>
                <div class="col-md-6 d-flex align-items-center">
                    <div class="card-body px-5 py-4">
                        <div class="text-center">
                            <img src="{{ asset('assets/images/logokomi.png') }}" alt="Logo" class="mb-3"
                                style="width: 80px" />
                            ...
                            <div class="position-relative mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" name="password" id="password"
                                        class="form-control form-control-lg" placeholder="Kata Sandi" />
