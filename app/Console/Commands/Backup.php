...
class Backup extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->option('current') == 1) {
            ...
            echo 'Berhasil backup data sebelumnya, jangan lupa nanti sebelum di seeder ulang Class=SeederUser di modif dulu bagian :username, email_verified_at, created_at, updated_at, agar tidak error, chuaaakss' .
                PHP_EOL;
        }
