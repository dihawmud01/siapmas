...
class NewsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $res = Http::withoutVerifying()->get('https://nuonline.cms.nu.or.id/api/v3/articles?lang=id&limit=2', [
            'lang' => 'id',
            'limit' => $onPage,
        ]);
        ...
        return view(
            'users.news.index',
            compact('data', 'recentNews', 'newsCategories', 'oldNews', 'tags', 'user', 'trending'),
        );
    }
