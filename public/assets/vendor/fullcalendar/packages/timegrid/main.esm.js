...
var TimeGrid = /** @class */ (function (_super) {
    ...
    function TimeGrid(context, el, renderProps) {
        ...
        _this.renderDateSelection = memoizeRendering(_this._renderDateSelection, _this._unrenderDateSelection, [
            renderColumns,
        ]);
...
var TimeGridView = /** @class */ (function (_super) {
    ...
    function TimeGridView(context, viewSpec, dateProfileGenerator, parentEl) {
        ...
        if (_this.opt('allDaySlot')) {
            ...
            _this.dayGrid = new DayGrid(_this.context, _this.el.querySelector('.fc-day-grid'), { // the all-day subcomponent of this view
